...
For the second argument, "0" denotes creating the mesh by refining the unit interval(1D)/square(2D) with a factor 2; "1" denotes using a certain numer of DoFs.
